...
myApp.controller("imageSelectMediaCtrl",function($scope, ImageUrl) {
        ...
        for (var i = 0; i < $scope.images.length; i++) {
            ...
            switch(span) {
                case 2:
                    ...
                    break;
                case 3:
                    $scope.images[i].size = "3";
                    break;
                default:
                    $scope.images[i].size = "1";
            }
        }
    });
    ...
    $scope.deleteImage = function (image) {
        ...
        ImageUrl.$delete(function () {
            indx = images.indexOf(image);
...
myApp.controller("imageUploadCtrl", function($scope, $stateParams, ImageUrl) {
    $scope.image = {};
